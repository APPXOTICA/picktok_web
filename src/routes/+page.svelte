<script lang="ts">
	...
	const siteUrl = 'https://picktok.co';

	const steps = [
		{
			title: 'Share',
			body: 'Tap Share on TikTok or YouTube Shorts and pick PickTok. The link comes straight in.'
		},
		{
			title: 'Thumbnail',
			body: 'PickTok grabs the cover image. Crop it the way you like it.'
		},
		{
			title: 'Drop it in a folder',
			body: 'Tap a folder and the video is filed. Find it again in seconds, not scrolls.'
		}
	];
	...
	const features = [
		{
			...
			body: 'Recipes › Italian › Pasta. Nest as deep as you like and color-code every folder.'
		},
		{
			icon: 'photo',
			title: 'Import from Photos',
			body: 'Already saved videos to your camera roll? Select several and move them in one go.'
		},
		{
			icon: 'grid',
			title: 'Multi Play',
			body: 'Play several downloaded videos side by side on one screen. Great for comparing moves.'
		},
		{
			icon: 'forward',
			title: 'Smart controls',
			body: 'Set your own skip seconds, jump back to the start, and skip TikTok’s end credits.'
		},
		{
			icon: 'lock',
			title: 'Privacy Lock',
			body: 'Keep your collection to yourself with Face ID or fingerprint unlock at launch.'
		},
		{
			icon: 'drag',
			title: 'Drag to reorder',
			body: 'Hold and drag folders into the order that makes sense to you.'
		}
	];
	...
	const folders = [
		{ name: 'See All', count: 30, color: 'var(--yellow)', filled: true },
		{ name: 'Recipes', count: 16, color: 'var(--blue)', filled: true },
		{ name: 'Workout', count: 14, color: 'var(--yellow)', filled: false },
		{ name: 'Travel', count: 9, color: 'var(--pink)', filled: true }
	];
</script>

<svelte:head>
	<title>PickTok — Organize your TikTok & YouTube Shorts favorites</title>
	<meta
		name="description"
		content="PickTok saves the short-form videos you love into colorful folders. Share from TikTok or YouTube Shorts, or import from your photo library. Available on iOS and Android."
	/>
	<link rel="canonical" href="{siteUrl}/" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="{siteUrl}/" />
	<meta property="og:title" content="PickTok — Your short videos, finally organized" />
	<meta
		property="og:description"
		content="Save TikTok and YouTube Shorts videos into folders you can actually find again."
	/>
...
<header class="nav container">
	...
	<nav>
		...
		<a href={appStoreUrl} class="nav-cta" target="_blank" rel="noopener">Get the app</a>
	</nav>
</header>
...
<main>
	<section class="hero container">
		<div class="hero-copy">
			<p class="eyebrow"><span class="dot"></span>For TikTok &amp; YouTube Shorts</p>
			<h1>Your short videos, <span class="accent">finally organized.</span></h1>
			<p class="lede">
				Liked it, saved it, never found it again? PickTok files the videos you love into colorful
				folders, so the recipe, the workout and the one that made you cry-laugh are always one tap
				away.
			</p>
			{@render storeButtons()}
			<p class="fine">Free to start · One-time upgrade, no subscription</p>
		</div>
			...
			<div class="phone">
				<div class="screen">
					<div class="appbar">
						...
						<span class="appbar-title">See All</span>
					</div>
					<div class="grid">
	...
	<section class="how container" aria-labelledby="how-title">
		<h2 id="how-title">From “oh I need to save this” to saved, in three taps.</h2>
		<ol class="steps">
	...
	<section id="features" class="features container" aria-labelledby="features-title">
		...
		<h2 id="features-title">Built for people who save a lot of videos.</h2>
	...
	<section class="pricing container" aria-labelledby="pricing-title">
		<h2 id="pricing-title">Pay once. Keep everything.</h2>
		<div class="plans">
			<div class="plan">
				<p class="plan-name">Free</p>
				<p class="plan-big">40 <span>videos</span></p>
				<ul>
					<li>All features included</li>
					<li>+10 more when you leave a review</li>
					<li>No account, no sign-up</li>
				</ul>
			</div>
			<div class="plan premium">
				<p class="plan-name">Premium</p>
				<p class="plan-big">Unlimited</p>
				<ul>
					<li>Save as many videos as you want</li>
	...
	<section class="cta container">
		<div class="cta-card">
			...
			{@render storeButtons()}
			<p class="guides-link">New here? <a href="/tutorial/">Read the quick guides →</a></p>
		</div>
	</section>
</main>
