<script lang="ts">
	const contactEmail = 'hello@appxotica.com';
	const lastUpdated = 'September 23, 2026';
</script>

<svelte:head>
	<title>PickTok Privacy Policy</title>
	<meta name="description" content="Privacy policy for the PickTok app." />
	<link rel="canonical" href="https://www.picktok.love/policy/" />
</svelte:head>
...
<main class="container policy">
	<h1>PickTok Privacy Policy</h1>
	<p class="updated">Last updated: {lastUpdated}</p>

	<p>
		I built the PickTok app as a freemium app. This Service is provided at no cost and is intended
		for use as is.
	</p>
	<p>
	...
	<p>
		The app does use third party services that may collect information used to identify you. Link
		to privacy policy of third party service providers used by the app:
	</p>
	<ul>
		<li>
			<a href="https://firebase.google.com/policies/analytics" rel="noopener">
	...
	<p>
		...
		aware that your child has provided us with personal information, please contact me so that I will
